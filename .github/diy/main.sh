...
git clone --depth 1 https://github.com/oooopera/phtunnel.git && mv -n phtunnel/luci-app-phtunnel ./ ; rm -rf phtunnel
...
git clone --depth 1 https://github.com/lxiaya/openwrt-homeproxy.git && mv -n openwrt-homeproxy/luci-app-homeproxy ./ ; rm -rf openwrt-homeproxy
