...
git clone https://github.com/shadowsocks/luci-app-shadowsocks.git ./luci-app-shadowsocks
git clone https://github.com/shadowsocks/openwrt-shadowsocks.git ./shadowsocks-libev
