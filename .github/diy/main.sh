...
git clone https://github.com/messense/aliyundrive-webdav.git  && mv aliyundrive-webdav aliyundrive-webdav-all && mv  -u aliyundrive-webdav/openwrt/aliyundrive-webdav ./ && mv -u aliyundrive-webdav/openwrt/luci-app-aliyundrive-webdav ./ ; rm -rf aliyundrive-webdav-all
